  ...
  using bindings_t = typename bindings<Ts...>::type;
      ...
      // clang-format on
                ...
                auto boundable_impl(I &&,
                                    T &&) -> aux::conditional_t<aux::is_same<T, aux::decay_t<T>>::value, boundable_impl__<I, T>,
                        typename type_<T>::has_disallowed_qualifiers>;
...
#define BOOST_DI_CFG_CTOR_LIMIT_SIZE 10
            ...
            namespace type_traits {
                ...
                struct ctor_traits__<T, _, aux::true_type>
      ...
      static T try_create(const TProvider&) noexcept;
                        ...
                        static detail::wrapper_traits_t<decltype(aux::declval<TGiven>()(
                                aux::declval<typename TProvider::injector_t>()))>
...
#define BOOST_DI_CFG ::boost::di::v1_1_0::config
            ...
            namespace concepts {
                ...
                -> aux::is_valid_expr<decltype(T::provider((injector<T> *) 0)), decltype(T::policies(
                        (injector<T> *) 0))>;
                ...
                auto is_configurable(const aux::true_type &) {
                    return typename get_configurable_error<decltype(providable<decltype(T::provider(
                            (injector<T> *) 0))>()),
    ...
    static inline T type(_ = "creating...");
                ...
                struct provider<aux::pair<T, aux::pair<TInitialization, TList<TCtor...>>>, TName, TInjector> {
                    ...
                    auto get(const TMemory &memory = {}) const {
                        return get_impl(memory, static_cast<const injector__<TInjector> *>(injector_)->create_impl(
                                aux::type<TCtor>{})...);
                    }
...
#endif
                        return TInjector::config::provider(injector_).template get<T>(TInitialization{}, memory,
                    ...
                    struct provider<aux::pair<T, aux::pair<TInitialization, TList<TCtor...>>>, TInjector> {
                        ...
                        auto get(const TMemory &memory = {}) const {
                            return TInjector::config::provider(injector_).template get<T>(
                                    ...
                                    static_cast<const injector__<TInjector> *>(injector_)->create_successful_impl(
                                            aux::type<TCtor>{})...);
                        }
